...
//07
// var info = ["SSC", "HSC", "BCS", "BS", "Bcom", "Ms", "Mphil", "phd"];

// document.writeln("Qualifications:<br>" + info);


// 08
// console.log("all is well");
// var stu = ["Hamza", "Ibrahim", "Ammar"];
// var scr = [320, 230, 480];
// console.log("score of Hamza is  " + scr[0] + "  percentage: " + (scr[0] / 500) * 100 + "%");
// console.log("score of Ibrahim is  " + scr[1] + "  percentage: " + (scr[1] / 500) * 100 + "%");
// console.log("score of Ammar is  " + scr[2] + "  percentage: " + (scr[2] / 500) * 100 + "%");
